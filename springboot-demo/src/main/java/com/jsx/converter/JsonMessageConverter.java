package com.jsx.converter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.pagehelper.PageInfo;
import com.jsx.entry.BizDataPage;
import com.jsx.entry.CODE;
import com.jsx.entry.ResponseT;
...
//        objectMapper.setSerializationInclusion(JsonInclude.Include.NON_NULL);               //对象中属性值为null时，不序列化
    ...
    protected void writeInternal(Object object, Type type, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        if (object != null) {
            if (object instanceof PageInfo || object instanceof Page) {  //处理分页查询
                response.setBizData(new BizDataPage<>(object));
            }else{
