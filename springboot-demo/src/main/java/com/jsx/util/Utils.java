...
import com.jsx.shiro.PlatformAccessControlFilter;
...
public class Utils {
    ...
    **/
    ...
    public static String getUserToken() {
        try {
            return PlatformAccessControlFilter.getUserLoginContext().getUserToken();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static Long getUserId() {
        try {
            return PlatformAccessControlFilter.getUserLoginContext().getUserId();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static String getLoginId() {
        try {
            return PlatformAccessControlFilter.getUserLoginContext().getLoginId();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static void clearLoginContext() {
        try {
            PlatformAccessControlFilter.clearLoginContext();
        } catch (Exception e) {
            return;
        }
    }
