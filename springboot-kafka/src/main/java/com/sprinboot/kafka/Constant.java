...
public class Constant {
     ...
     */
    public static final String USER_TOKEN_REDIS_KEY = "user_token:token=%s";
    ...
    public static final String USER_INCREMENT_NUM_KEY = "global_id:user_increment_num_key";

    /**短链接唯一id生成key，通过redis生成*/
    public static final String URL_INCREMENT_NUM_KEY = "global_id:url_increment_num_key";
