package com.springboot.sitemesh.base.service.impl;/**
 * Created by dell on 2017/11/24.
 */

import com.springboot.sitemesh.base.dao.BaseRepository;
import com.springboot.sitemesh.base.entity.BaseEntity;
import com.springboot.sitemesh.base.service.BaseService;
...
public abstract class BaseServiceImpl<T extends BaseEntity, ID extends Serializable> implements BaseService<T, ID> {
    ...
    public T insert(T entity) {
        return getBaseRepository().insert(entity);
    }

    @Override
    public List<T> insert(Iterable<T> entitys) {
        return getBaseRepository().insert(entitys);
    }
